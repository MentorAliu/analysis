...
internal static class Check
{
    ...
    public static void Equal<T>(T expected, T actual, string message) => That(EqualityComparer<T>.Default.Equals(expected, actual), message + $"; expected={expected}, actual={actual}");
